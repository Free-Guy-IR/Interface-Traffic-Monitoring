...
## ✨ قابلیت‌ها
-داشبورد لحظه‌ای شبکه؛ ببین، مقایسه کن، کنترل کن

-مسدودسازی دامنه/IP با یک کلیک + صفحهٔ هشدار شیک برای کاربر

-گزارش‌های روزانه/ماهانهٔ آمادهٔ ارائه (Traffic usage)

-محدودیت سرعت آپلود فوری برای مدیریت پهنای‌باند

-کنترل اینترفیس‌ها از داخل پنل (روشن/خاموش)

-پایش پینگ و کیفیت اینترنت با تشخیص قطعی و تأخیر

-رابط فارسی، مد تیره/روشن، سازگار با موبایل

-سبک و سریع؛ بدون دیتابیس، نصب ساده روی لینوکس

-بازیابی خودکار قوانین بعد از ری‌استارت؛ خیال راحت

-مناسب برای سرور VPN، روتر، دفاتر و تیم‌های کوچک
